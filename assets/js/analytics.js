// PostHog analytics, reporting to the same project as ParlayCards.ai.
// Only runs on the production domain, so local previews send nothing.
if (location.hostname === 'bantamlabs.com') {
  ...
  posthog.init('phc_ta4gZf7R6fu24Z4NJE3VYhHookWc52x7tP5gxdU9qnvN', {
    api_host: 'https://p.bantamlabs.com',
    ui_host: 'https://us.posthog.com',
    defaults: '2026-05-30',
    disable_session_recording: true,
  });
  // Tags every event so insights can split this site from ParlayCards.ai.
  posthog.register({ site: 'bantamlabs.com' });
}
